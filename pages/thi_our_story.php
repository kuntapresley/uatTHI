...
<html>
    ...
    <head>
       ...
       <title>Health Education and Tips | Timob Health International | Hepatitis Corner | Outreach | Our Story</title>
       <meta charset="UTF-8">
    ...
    <body>
        ...
        <main>
            ...
            <div class="c_content">
                    ...
                    <div class="c_c_t_h_c c_content_title_container c_general_container">
                        ...
                        <div class="c_general_one">
                            ...
                            <h1 class="c_content_title c_general">
                                Our Health Planning and Wellbeing
                            </h1>

                            <ul class="c_content_title_list">
                                <li><a href="#health_plans_page">Health Planning</a></li>
                                <li><a href="#self_and_family_health_planing">self and family health planing</a></li>
                                <li><a href="#health_consultant_in_nigeria">health consultant in nigeria</a></li>
                                <li><a href="#health_references">health references</a></li>
                        ...
                        <div class="c_general_two">
                            ...
                            <section class="c_our_story_sections  c_our_story_sections_A" id="health_plans_page">
                           
                           
                                <div  class="c_our_story_sections_header">
                                ...
                                <div class="c_our_story_sections_main">
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="self_and_family_health_planing">

                            <div  class="c_our_story_sections_header">

                                <h1 class="c_content_title c_general">
                                    self and family health planing
                                </h1>
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="health_consultant_in_nigeria">

                            <div  class="c_our_story_sections_header">

                                <h1 class="c_content_title c_general">
                                    health consultant in nigeria
                                </h1>
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="health_references">
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="hepatitis">
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="outreach"> 

                            <div  class="c_our_story_sections_header">

                                <h1 class="c_content_title c_general">
                                    Outreach at Timob Health International Organization
                                </h1>
                            ...
                            <section class="c_our_story_sections c_our_story_sections_A" id="health_wellness">
                ...
                <!-- <div class="c_general_details_container">

                    <div class="c_general_details_one c_general_details">

                        <div class="c_general_us_form">
                            ...
                            <form id="c_general_form" action="" method="">


                                <div class="c_form_item_row">
                                <label for="c_general_form_name" id="c_general_name" class="c_general_form_heading">Name</label>
                                <input type="text" name="c_general_form_name" class="c_general_form_details" id="c_general_form_name" required placeholder="Enter Full Name"/>
                                </div>

                                <br>

                                <div class="c_form_item_row">
                                <label for="c_general_form_tel" id="c_general_form_tel" class="c_general_form_heading">Telephone</label>
                                <input type="tel" name="c_general_form_tel" class="c_general_form_details" id="c_general_form_tel" required placeholder="Enter Telephone Number"/>
                                </div>

                                <br>
                                
                                <div class="c_form_item_row">
                                <label for="c_general_form_email" id="c_general_form_email" class="c_general_form_heading">Email</label>
                                <input type="email" name="c_general_form_email" class="c_general_form_details" id="c_general_form_email" required placeholder="Enter Email Address"/>
                                </div>

                                <br>
                                
                                <div class="c_form_item_row">
                                <label for="c_general_form_message" id="c_general_form_message" class="c_general_form_heading">Message</label>
                                <textarea name="c_general_form_message" class="c_general_form_details" id="c_general_form_message" required placeholder="Enter Message"></textarea>
                                </div>

                                <br>
                                
                                <div class="c_form_item_row">
                                <input type="submit" value="Send Enquires" class="c_general_form_submit" id="c_general_form_submit"/>
                                </div>
                    ...
                    <div class="c_general_details_two c_general_details">
                       
                        <div class="c_general_details_two_details c_general_details_two_details_one">
                            <p>General Inquiries</p>
                        </div>

                        <div class="c_general_details_two_details c_general_details_two_details_two">
                            <p>Call :</p> <p><a href="tel:+234 1 448 0815">+234 1 448 0815</a></p> <p><a href="tel:+234 1 448 0816">+234 1 448 0816</a></p>
                        </div>

                        <div class="c_general_details_two_details c_general_details_two_details_three">
                            <p>Fax :</p> <p><a href="tel:+234 1 448 0815">+234 1 448 0815</a></p> <p><a href="tel:+234 1 448 0816">+234 1 448 0816</a></p>
                        </div>
                        
                        <div class="c_general_details_two_details c_general_details_two_details_four">
                            <p>Email :</p> <p><a href="mailto:communications@timobhealth.com">communications@timobhealth.com</a></p>
                        </div> 

                        <div class="c_general_details_two_details c_general_details_two_details_five">
                    ...
                    <div class="c_general_details_three c_general_details">
                        <div class="c_general_map">            
