                            ...
                            <div class="c_create_an_account">
                                ...
                                <form method="" action="" onsubmit="">
                                    ...
                                    <div class="c_create_an_account_section c_create_an_account_section_one">
                                        ...
                                        <input type="text" id="c_create_an_account_accountName" class="c_create_an_account_inputs"/>
                                    </div>
                                    ...
                                    <div class="c_create_an_account_section c_create_an_account_section_two">
                                        ...
                                        <input type="text" id="c_create_an_account_accountEmail" class="c_create_an_account_inputs"/>
                                    </div>
                                    ...
                                    <div class="c_create_an_account_section c_create_an_account_section_three">
                                        ...
                                        <input type="text" id="c_create_an_account_accountPhone" class="c_create_an_account_inputs"/>
                                    </div>
                                    ...
                                    <div class="c_create_an_account_section c_create_an_account_section_four">
                                        ...
                                        <input type="text" id="c_create_an_account_accountPassword" class="c_create_an_account_inputs"/>
                                    </div>
                                    
                                    <div class="c_create_an_account_section c_create_an_account_section_five">
                                        <label for="c_create_an_account_accountSubmit" id="c_create_an_account_accountSubmit" class="c_create_an_account_labels">Submit Account </label>
                                        <input type="submit" id="c_create_an_account_accountSubmit" class="c_create_an_account_inputs" value="Submit"/>
                                    </div>
